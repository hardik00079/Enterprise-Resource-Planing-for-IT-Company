    ...
    <nav class="navbar navbar-inverse"  role="navigation">  
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" style=" margin-left:-20px;" href="#">Maxgen Technologies</a>              
          <!-- IMG BASED LOGO  -->
           <!-- <a class="navbar-brand" href="index.html"><img src="assets/images/logo.png" alt="logo"></a> -->
        </div>
        <div id="navbar" class="navbar-collapse collapse">
          <ul id="top-menu" class="nav navbar-nav navbar-right main-nav">
       <li class="active"><a href="HRIndex.jsp">Home</a></li>
       <li><a href="HRProjectDetail.jsp">Projects</a></li>
            <li><a href="HRLeaveDetail.jsp">Leaves</a></li>
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu" role="menu">
                <li><a href="HRAddBlogs.jsp">Add Blogs</a></li>                
                <li><a href="HREditBlogs.jsp">Update/Delete Blogs</a></li>
